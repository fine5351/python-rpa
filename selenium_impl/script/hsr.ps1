...
python ./selenium_impl/main.py multi --folder "F:\2026-06-06-異相仲裁-嗡鳴如笑" --desc "練度展示於結尾" --tags "崩壞星穹鐵道,honkaistarrail,嗡鳴如笑" --playlist "崩壞:星穹鐵道-高難"

python ./selenium_impl/main.py multi --folder "F:\2026-06-08-末日幻影-遺忘冽風" --desc "練度展示於結尾" --tags "崩壞星穹鐵道,honkaistarrail,遺忘冽風" --playlist "崩壞:星穹鐵道-高難"
